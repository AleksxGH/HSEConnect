...
class HseSidebar extends HTMLElement {
  ...
  async updateChatIcon() {
    ...
    chatIcon.src = hasUnread ? `${basePath}icons/chat_dot_icon.svg` : `${basePath}icons/chat_icon.svg`;
  }
  ...
  async updateNotificationsIcon() {
    ...
    notificationsIcon.src =
        hasUnread ? `${basePath}icons/notifications_dot_icon.svg` : `${basePath}icons/notifications_icon.svg`;
  }
